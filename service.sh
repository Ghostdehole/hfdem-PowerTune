...
init_zram() {
    ...
    echo "0" > /sys/class/block/zram0/disksize
}
...
init_mem() {
    ...
    write_val "25" /proc/sys/vm/watermark_scale_factor
    write_val "15000" /proc/sys/vm/watermark_boost_factor
    write_val "1" /proc/sys/vm/overcommit_memory
    write_val "0" /proc/sys/vm/swappiness
    write_val "2097152" /proc/sys/vm/min_free_kbytes
...
init_network() {
    ...
    write_val "30" /proc/sys/net/ipv4/tcp_fin_timeout
    write_val "1" /proc/sys/net/ipv4/tcp_mtu_probing
    write_val "3" /proc/sys/net/ipv4/tcp_fastopen
    write_val "1" /proc/sys/net/ipv4/tcp_tw_reuse
    write_val "bbr" /proc/sys/net/ipv4/tcp_congestion_control
    write_val "fq" /proc/sys/net/core/default_qdisc
}
...
init_android_config() {
    ...
    device_config put activity_manager freeze_debounce_timeout 300000
    device_config put activity_manager_native_boot freeze_debounce_timeout 300000

    device_config put activity_manager bg_auto_restrict_abusive_apps 0
    device_config put activity_manager bg_current_drain_auto_restrict_abusive_apps_enabled 0
}
...
init_corectl() {
    ...
    lock_val_in_path "0" "/sys/devices/system/cpu" "core_ctl" "min_cpus"
...
init_cpuset() {
    ...
    lock_val "7" /proc/irq/default_smp_affinity
